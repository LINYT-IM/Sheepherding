...
void sheepMover(Sheep* sheeps, Player *player, int n, int limit, std::vector<int> movesheep, std::pair<float, float> goal);

bool checkStatus(Sheep *sheeps,std::vector<int> ava, int n);
