...
int main(){
    ...
    for(int input_n = 20 ; input_n<=20 ; input_n+=5){
        for(int input_index =0 ; input_index<1; input_index++){
            string filename_move  = "movement/S1_case_" + ::to_string(input_n)+"_"+std::to_string(input_index)+"_1.txt";
            string filename_midP  = "midP/S1_case_" + ::to_string(input_n)+"_"+std::to_string(input_index)+"_1.txt";
